...
\begin{document}
	...
	The app needs to also be secure when handling people۪s donations, so their information will need to be encrypted. 
	...
	The app should be able to be maintained by the existing website development team at Calvary Chapel Corvallis. 
